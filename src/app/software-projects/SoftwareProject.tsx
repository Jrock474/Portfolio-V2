  ...
  return (
    <>
      <div className="software-project">
        ...
        <strong className="software-project-name">{softwareProject.title}</strong>
        <p className="software-project-description">{softwareProject.description}</p>
        <div className="software-button-container">
          <a target="_blank" rel="noopener noreferrer" href={softwareProject.gitHub}>
            Github
          </a>
          <a target="_blank" rel="noopener noreferrer" href={softwareProject.website}>
            Website
          </a>
        </div>
      </div>
